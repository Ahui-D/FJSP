...
OUT_DIR = Path('exp_runs/ablation_ocmappo_no_local_reward_s22_3sd10x5_e100')
...
env_configs.agent_c_candidate_generation_mode = 'rule'
...
cfg = OCMAPPOConfig(
    ...
    o_reward_beta_shape=0.0,
    o_reward_beta_shape_end=0.0,
    o_teacher_coef=0.0,
    ...
    m_reward_beta_shape=0.0,
    m_reward_beta_shape_end=0.0,
    m_teacher_coef=0.0,
    m_teacher_coef_end=0.0,
    m_teacher_coef_min=0.0,
...
(OUT_DIR / 'run_config.json').write_text(json.dumps({
    ...
    'candidate_generation_mode': 'rule',
...
(OUT_DIR / 'rule_train_summary.json').write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding='utf-8')
